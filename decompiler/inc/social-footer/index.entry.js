...
safeReactRender(
  <SocialFooter
    socialLinks={[
      {
        href:
          '//dotnettools-support.jetbrains.com/hc/en-us/community/topics/200379925-dotPeek',
        type: 'forum'
      },
      {
        href: '//youtrack.jetbrains.com/issues/DOTP',
        type: 'bug'
      },
      {
    ...
    socialNetworksLinks={[
      {
        href: '//twitter.com/dotpeek',
        type: 'twitter',
        text: i18n._(t`@dotpeek on Twitter`)
      }
    ]}
  />,
  'social-footer'
